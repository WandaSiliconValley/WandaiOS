...
class ClassRSVPNetworkController {
    static func reserveWandaClass(classId: Int, motherId: Int, childcareNumber: Int, resultHandler: @escaping (Bool, Error?) -> Void) {
    ...
    static func cancelWandaClassReservation(classId: Int, motherId: Int, resultHandler: @escaping (Bool, Error?) -> Void) {
